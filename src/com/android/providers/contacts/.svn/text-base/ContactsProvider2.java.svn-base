...
public class ContactsProvider2 extends SQLiteContentProvider implements OnAccountsUpdateListener {
    ...
    private static final int CUSTOM_CONTACTS=20000;
    private static final int CUSTOM_CONTACTS_SEARCH=20001;
    ...
    static {
        ...
        /*Add begin, custom by 139's contacts*/ 
        matcher.addURI(ContactsContract.AUTHORITY, "custom_contacts", CUSTOM_CONTACTS);
        matcher.addURI(ContactsContract.AUTHORITY, "custom_contacts/search/*", CUSTOM_CONTACTS_SEARCH);
        /*End begin, custom by 139's contacts*/ 
    }
    ...
    static {
        ...
        sContactsProjectionMap.put(Contacts.Data.DATA1, Contacts.Data.DATA1);
        sContactsProjectionMap.put(RawContacts.ACCOUNT_TYPE, RawContacts.ACCOUNT_TYPE);
    ...
    private static void addProjection(HashMap<String, String> map, String toField, String fromField) {
    	if(toField.equals(Contacts.CONTACT_PRESENCE))
    	{
...
//                String sort_key = (String)values.get("sort_key");
//                if(sort_key!=null)
//                {
//                	sort_key = ContactLocaleUtils.getIntance().getSortKey(sort_key);
//                	values.put("sort_key", sort_key);
//                	values.put("sort_key_alt", sort_key);
//                }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            ...
            case CONTACTS_FILTER: {
                ...
                selection +=" AND ( sort_key like '%"+filterParam+"%' OR display_name like '%"+filterParam+"%'  OR data1 like '%"+filterParam+"%') ";
                break;
            }
...
//                setTablesAndProjectionMapForContacts(qb, uri, projection);
            	qb.setTables(mDbHelper.getCustomContactsView());
            ...
            case CUSTOM_CONTACTS_SEARCH:{
                String keyWord = "";
                if (uri.getPathSegments().size() > 2) {
                	keyWord = uri.getLastPathSegment();
                }
            	setTablesForCustomContactSearch(qb,keyWord);
            	break;
            }
            /*End begin, custom by 139's contacts*/ 
            default:
	...
	private void setTablesForCustomContactSearch(SQLiteQueryBuilder qb,
			String keyWord) {
		String temp=keyWord;
		...
		String tables = " ( SELECT "
				...
				+ ") LIKE UPPER ('%"
				+ keyWord
				+ "%') OR UPPER(DATA_SYNC1) LIKE UPPER('%"
				+ keyWord
				+ "%')) AND "
				+ DataColumns.CONCRETE_MIMETYPE_ID
				+ " IN ( "
    ...
    private void setTablesAndProjectionMapForContactsWithSnippet(SQLiteQueryBuilder qb, Uri uri,
        ...
        /* liangbo ʱ޸
        sb.append(Views.CUSTOM_CONTACTS);
