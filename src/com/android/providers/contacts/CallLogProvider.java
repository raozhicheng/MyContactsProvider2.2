...
public class CallLogProvider extends ContentProvider {
    ...
    static {
        ...
        sCallsProjectionMap.put(Calls._ID, "calls."+Calls._ID);
    ...
    private static final HashMap<String,String> sCallsExtendProjectionMap;
    static {
    	sCallsExtendProjectionMap=new HashMap<String,String>();
    	sCallsExtendProjectionMap.putAll(sCallsProjectionMap);
    	sCallsExtendProjectionMap.put(RawContacts.ACCOUNT_TYPE, RawContacts.ACCOUNT_TYPE);
    }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs,
        ...
        switch (match) {
            case CALLS: {
                ...
                qb.setTables("calls Left outer join " + Views.CUSTOM_CONTACTS + " on " + Data.DATA1 + " = " + Calls.NUMBER );
                qb.setProjectionMap(sCallsExtendProjectionMap);
                /*Modify begin, custom by 139's contacts*/ 
                break;
            }
